...
//
//class Distance(private val mMap: GoogleMap) {
//
//    /**
//     * 経路を引く
//     *
...
//     */
//    fun search(origin: LatLng, place: MutableList<LatLng>) {
//
//        // TODO: 正式リリース時に消す
//        // TODO: debug push用
//        if (false) {
...
//
//                        /*ここから 移動距離のやつ 池田ま #xx*/
//                        val distance = legs.getJSONObject(j).getJSONArray("distance")
//                        val distancetext =
//                            distance.getJSONObject(0).getJSONObject("text")
//                        /*ここまで 池田ま #xx*/
//
